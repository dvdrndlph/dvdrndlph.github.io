...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.defineProperty = "function" == typeof Object.defineProperties ? Object.defineProperty : function (m, w, r) {
    if (r.get || r.set) throw new TypeError("ES3 does not support getters and setters.");
    m != Array.prototype && m != Object.prototype && (m[w] = r.value)
};
...
$jscomp.arrayIterator = function (m) {
    ...
    return $jscomp.iteratorPrototype(function () {
        return w < m.length ? {done: !1, value: m[w++]} : {done: !0}
    })
};
...
$jscomp.iteratorFromArray = function (m, w) {
    $jscomp.initSymbolIterator();
...
$jscomp.polyfill = function (m, w, r, u) {
    if (w) {
        r = $jscomp.global;
        m = m.split(".");
...
$jscomp.findInternal = function (m, w, r) {
    m instanceof String && (m = String(m));
    for (var u = m.length, t = 0; t < u; t++) {
        var z = m[t];
        if (w.call(r, z, t, m)) return {i: t, v: z}
    }
    return {i: -1, v: void 0}
};
...
(function () {
    ...
    function L(a, b,
        ...
        64 < c && (a = b / c, d = Math.floor(a), a - d < .1 * a && (b = d, c = 1), d = G(Math.round(64 * b / c) || 1, 64), t("denominator too small: %d/%d rounded to %d/%d", [b, c, d[0], d[1]]), b = d[0], c = d[1]);
    ...
    function Y(a, b) {
        ...
        for (var c = 0, d = [], e = [], f = 0; f < a.length; ++f) {
            ...
            if (g instanceof C) g.tijd < c && (g.tijd = c), d.push(g), c = g.tijd; else {
                if (g.tijd < c) {
                    ...
                    var h = d[d.length - 1];
                    if (h.tijd <= g.tijd) if ("z" == h.ns[0]) h.dur = g.tijd - h.tijd, 0 == h.dur && d.pop(), t("overlap in part %d, measure %d: rest shortened",
        ...
        0 == c && t("empty measure in part %d, measure %d, it should contain at least a rest to advance the time!",
            [b.ixp + 1, b.ixm + 1]);
        return d
    }
    ...
    function Z(a) {
        function b(a) {
            a = u('<part-group number="%d" type="%s"></part-group>', [a, "stop"]);
            a = (new window.DOMParser).parseFromString(a, "text/xml").firstChild;
            return $(a)
        }
        ...
        d = [];
        h = a.children();
        for (g = 0; g < h.length; g++) a = $(h[g]), "part-group" == a[0].nodeName ? (e = a.attr("number"), f = a.attr("type"), k = d.indexOf(e), "start" == f ? -1 < k ? (c.push(b(e)), c.push(a)) : (c.push(a), d.push(e)) : -1 < k && (d.splice(k, 1), c.push(a))) : c.push(a);
    ...
    function P(a, b, c, d, e, f) {
        if ("name_tuple" == a[0]) d = d.shift(), b[0] && (a[1] = b[0] + ":" + a[1], a[2] = b[1] + ":" + a[2]), e.push(a), f.push.apply(f, O(d)); else if (2 == a.length) d =
            d.shift(), c = ["name_tuple", "", ""], c[1] = a[0][1] + ":" + a[1][2], c[2] = a[0][2] + ":" + a[1][3], e.push(c), f.push.apply(f, O(d)); else {
            var g, h, k;
            k = a[a.length - 1];
            b = k[0];
            g = k[1];
        ...
        for (var b = "", c = a.children(), d = 0; d < c.length; ++d) {
            ...
            switch (e.nodeName) {
                case "elision":
                    ...
                    break;
                case "text":
                    b += $(e).text().replace(/_/g, "\\_").replace(/-/g,
                        "\\-").replace(/ /g, "~")
            }
        }
        if (!b) return b;
    ...
    function ba(a) {
        ...
        for (d = 0; d < a.length; ++d) if (e = a[d], 0 <= e.indexOf("I:percmap") && (e = e.split(" ").map(function (a) {
            return a.trim()
        }), f = e[4], f in b && (f = f + "+," + f), e = "%%map perc" + g + " " + e[1] + " print=" + e[2] + " midi=" + e[3] + " heads=" + f, h[g].push(e)), 0 <= e.indexOf("V:") &&
        (f = e.match(/V:\s*(\S+)/))) g = f[1], g in h || (h[g] = []);
    ...
    D.prototype.prcnt = function (a) {
        for (var b in this.counters.note) 0 != this.getv("nopr", b) && t("part %d, voice %d has %d skipped non printable notes", [a, b, this.getv("nopr", b)]), 0 != this.getv("nopt", b) && t("part %d, voice %d has %d notes without pitch", [a, b, this.getv("nopt", b)]), 0 == this.getv("note", b) && t("part %d, skipped empty voice %d", [a, b])
    };
    ...
    y.prototype.incTime = function (a) {
        this.tijd += a;
        0 > this.tijd && (this.tijd = 0);
        this.tijd > this.maxtime && (this.maxtime = this.tijd)
    };
    y.prototype.appendElemCv = function (a, b) {
        for (var c in a) this.appendElem(c, b)
    };
    y.prototype.insertElem = function (a, b) {
        var c = new C(b);
        c.tijd = 0;
    ...
    y.prototype.appendElemT = function (a, b, c) {
        b = new C(b);
        b.tijd = c;
        this.voices[a].push(b)
    };
    y.prototype.appendElem = function (a, b, c) {
        this.appendObj(a, new C(b), 0);
        c && this.cnt.inc("note", a)
    };
    y.prototype.appendNote = function (a, b, c) {
        b.ns.push(b.ntdec + c);
    ...
    y.prototype.getLastMelis = function (a, b) {
    ...
    y.prototype.addChord = function (a, b) {
    ...
    y.prototype.outVoices = function (a, b) {
        ...
        for (l in this.vnums) if (0 != this.cnt.getv("note",
            ...
            for (p = 0; p < this.gMaten.length; ++p) {
                ...
                f = void 0;
                n = this.gLyrics;
                if (0 != p) for (f in c = this.gMaten[p][l], d = n[p][l], n = n[p - 1][l], n) if (B = n[f][1], !(f in d) && B) {
                    B = c;
                    u = [];
                    for (t = 0; t < B.length; ++t) if (r =
                ...
                for (e in c) if (f = c[e], f = f[0], e in q) {
                    ...
                    q[e].push(f)
                } else q[e] = w(p, "").concat([f])
            }
            for (e in q) f = q[e], h = m.length - f.length, q[e] = f.concat(w(h, ""));
            v.add("V:" + this.vceCnt);
            ...
            for (h = 0; m.length;) {
                ...
                m.splice(0, p);
                c = J(q, 1);
                for (d = 0; d < c.length; ++d) f = c[d], e = f[0], f = f[1], v.add("w: " + f.slice(0, p).join("|") + "|"), f.splice(0, p)
            }
            g[l] = this.vceCnt;
            this.vceCnt += 1
        }
    ...
    E.prototype.mkHeader =
        function (a, b, c, d, e) {
            ...
            b = g.join(" ");
            a = {};
            for (n = 0; n < p.length; ++n) k = p[n], h = f[n], l = h[1], h = h[2], 0 != k.length && (k = k[0][0], l = l.replace(/\n/g, "\\n").replace(/\.:/g, ".").replace(/^:|:$/g, ""), h = h.replace(/\n/g, "\\n").replace(/\.:/g, ".").replace(/^:|:$/g, ""), a[k] = (l ? 'nm="' + l + '"' : "") + (h ? ' snm="' + h + '"' : ""));
            f = [u("X:%d\n%s\n", [this.X, this.title])];
            "" !== this.scale &&
            ...
            if (c.length) {
                ...
                c.forEach(function (a) {
                    m.push(1 < a.length ? u(r, [a, a]) : u(B, [a, a]))
                });
    ...
    x.prototype.ntAbc = function (a, b, c, d, e, f) {
        ...
        if ("" != h) k = g[h]; else {
            ...
            if (c.find("tie").add(c.find("notations>tied")).get().some(function (a) {
                return "stop" == a.getAttribute("type")
            })) return b;
    ...
    x.prototype.doNote = function (a) {
        ...
        var d = 0 < a.find("chord").length, e = a.find("pitch>step").text() || a.find("unpitched>display-step").text(),
            f = a.find("pitch>octave").text() || a.find("unpitched>display-octave").text(),
            g = 0 < a.find("rest").length,
            h = a.find("time-modification>actual-notes").text();
        if (h) {
        ...
        if (a.find("unpitched").length) {
            ...
            if ("circle-x" == l || "diamond" == l || "triangle" == l) g = "_" + g.replace(/\^/g, "").replace(/_/g, "");
            "yes" == k.attr("filled") && (l += "+");
            "no" == k.attr("filled") && (l += "-");
        ...
        e.some(function (a) {
            return "start" == a.getAttribute("type")
        }) && (g += "-");
        ...
        e = a.find("stem").text();
        !this.wstems || "up" != e && "down" != e || e == this.stemDir[c] || (this.stemDir[c] = e, this.msc.appendElem(c,
            u("[I:stemdir %s]", [e])));
    ...
    x.prototype.doAttr = function (a) {
        ...
        b = {
            C1: "alto1", C2: "alto2", C3: "alto", C4: "tenor", F4: "bass", F3: "bass3", G2: "treble",
        ...
        if (d = a.find("time>beats").text()) f = a.find("time>beat-type").text(), g = d + "/" + f, e ? v.mtr = g : this.msr.attr += "[M:" + g + "]", this.msr.mdur =
        ...
        a.find("measure-style").each(function () {
            ...
            $(this).find("measure-repeat").each(function () {
                ...
                })) : "stop" == c && (d = n.repeat_str[a][0], f = n.repeat_str[a][1], e = n.msr.ixm - d, f ? (g = f + " ", e /= parseInt(f)) : g = "", n.repeat_str[a][0] = u("[I:repeat %s%d]", [g, e]), delete n.repeat_str[a])
            })
        });
        ...
        for (f = 0; f < g.length; f++) {
            ...
            if (p.length && (p.attr("number") || 1) == d) {
                if (h = p.find("staff-lines").text()) k = "3" == h &&
            ...
            this.curClef[d] = l;
            if (e) this.clefMap[d] = l; else for (h = this.stfMap[d], q = 0; q < h.length; ++q) p = h[q], d != this.curStf[p] && (m = d - this.curStf[p], this.curStf[p] = d, k = 0 < m ? "+" : "", this.msc.appendElem(p, "[I:staff " + k + m + "]")), this.msc.appendElem(p,
                "[K:" + l + "]")
        }
    };
    x.prototype.findVoice = function (a, b) {
        var c, d, e, f;
        e = b.eq(a);
        ...
        for (f = a + 1; f < b.length; ++f) {
            e = b.eq(f);
            if ("note" == e.prop("nodeName")) return c = parseInt(e.find("staff").text() || "1"), e = parseInt(e.find("voice").text() || "1"), this.isSib && (e += 100 * c), c = this.vce2stf[e], {
                sn: c,
                v: e,
                v1: d
            };
            if ("backup" == e.prop("nodeName")) break
        }
    ...
    x.prototype.doDirection = function (a, b, c) {
        ...
        function e(a, b, c, e) {
            ...
            k = g.attr("type") || "";
            f = b + (g.attr("number") || "1");
            if (k in l) l = l[k], f in a.dirStk ? (h = a.dirStk[f], delete a.dirStk[f], "stop" == h.type ? d(a, l, c, h.tijd, e) : (t("%s direction %s has no stop in part %d, measure %d, voice %d", [b, h.type,
                a.msr.ixp + 1, a.msr.ixm + 1, c + 1]), a.dirStk[f] = {type: k, vs: c})) : a.dirStk[f] = {
                type: k,
                vs: c
            }; else if ("stop" == k) f in a.dirStk ? (h = a.dirStk[f], delete a.dirStk[f], k = h.type, c = h.vs, "stop" == k ? (t("%s direction %s has double stop in part %d, measure %d, voice %d", [b, k, a.msr.ixp + 1, a.msr.ixm + 1, c + 1]), l = "") : l = l[h.type].replace("(", ")").replace("ped", "ped-up")) : (a.dirStk[f] = {
                type: "stop",
                tijd: a.msc.tijd
            }, l = ""); else throw"wrong direction type";
            d(a, l, c, null, e)
        }
        ...
        if (g.length) {
            ...
            if (n.length) {
                ...
                for (w in this.vceInst) this.vceInst[w] == n.attr("id") && (b = w);
                (w = (h ? h - 1 : r) + "") && 0 < v.volpan && this.msc.appendElem(b, "[I:MIDI= " + (h ? "program" : "channel") + " " + w + "]")
            }
            if (h = g.attr("tempo")) h = parseFloat(h).toFixed(0), y = [1, 4];
            for (q in z) if (g.attr(q)) {
                A =
                    z[q];
                break
            }
    ...
    x.prototype.doPrint = function (a) {
    ...
    x.prototype.mkTitle = function (a) {
        ...
        f = function (a) {
            ...
            var h = [], k, l;
            for (l = 0; l < f.length; ++l) k = f[l], 6 > a && (k && -1 < b.indexOf(k) || k && -1 < c.indexOf(k)) || 5 > a && (k && -1 < d.indexOf(k) || k && -1 < e.indexOf(k)) || 4 > a && (b && -1 < k.indexOf(b) || c && -1 < k.indexOf(c)) || 3 > a && (d.some(g) || e.some(g)) || 2 > a && /^[\d\W]*$/.test(k) || h.push(k);
            0 == a && b + c && (h = "");
            return h
        }(this.ctf);
        b && (b = "T:" + b.replace(/\n/g, "\nT:") + "\n");
    ...
    x.prototype.locStaffMap = function (a, b) {
        ...
        this.clefMap = {};
        for (var d =
            a.find("measure>note"), e = 0; e < d.length; e++) {
    ...
    x.prototype.addStaffMap = function (a) {
        ...
        for (c = 0; c < l.length; ++c) {
            ...
            g = [];
            h = [];
            for (b = 0; b < e.length; ++b) d = e[b], d in a && (g.push(a[d]), h.push(void 0 == this.hasStems[d]));
            if (g.length) for (k.push(g), e = (f in this.clefMap) ? this.clefMap[f] : "treble", b = 0; b < g.length; ++b) d = g[b], f = "", 0 == e.indexOf("tab") && (h[b] && 0 > e.indexOf("nostems") &&
    ...
    x.prototype.addMidiMap = function (a, b) {
        ...
        }), h = b[g], e = this.vceInst[g] || "", e in c ? f.push([h, c[e].concat(k)]) :
            f.push([h, d.concat(k)]);
        f.sort(function (a, b) {
            return a[0] - b[0]
        });
        ...
        for (var m, t, q = "0 1- 1 1+ 2 3 3 4 4 5 6 6+ 7 8- 8 8+ 9 10 10 11 11 12 13 13+ 14".split(" "), e = Object.keys(this.tabmap).sort(), c = 0; c < e.length; ++c) h = e[c], f = h.match(/(\d+),(.*)/), g = f[1], t = f[2], k = this.tabmap[h][0], m = this.tabmap[h][1], this.diafret && (m = q[parseInt(m)]), h = b[g], k = this.stafflines - parseInt(k), f = this.tabVceMap[h] || [], f.push(u("%%map tab%d %s print=%s heads=kop%s\n",
    ...
    x.prototype.parse = function (a) {
        ...
        for (var d = c.find("part"), e = 0; e < d.length; ++e) {
            ...
            for (this.msr = new K(e); this.msr.ixm < g.length;) {
                ...
                this.curalts =
                    {};
                for (var r = k.children(), q = 0; q < r.length; q++) switch (c = r.eq(q), c[0].nodeName) {
                    case "note":
                        this.doNote(c);
                        break;
                    case "attributes":
            ...
            for (var n in this.repeat_str) g = this.repeat_str[n], g[0] = u("[I:repeat %s %d]", [g[1], 1]);
    ...
    vertaal = function (a, b) {
        var c = {
            u: 0, b: 0, n: 0, c: 0, v: 0, d: 0, m: 0,
            x: 0, t: 0, v1: 0, noped: 0, stm: 0, p: "f", s: 0
        }, d;
        for (d in b) c[d] = b[d];
        c.p = c.p ? c.p.split(",") : [];
        v = new E(".abc", "", 0, c);
